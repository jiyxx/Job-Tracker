...
import { fetchStats, fetchApplications, generateApplicationSummary } from "../store/applicationsSlice";
...
const SummaryCard = ({ label, value, subtext, valueClass, onClick }) => (
  ...
  >
    ...
    {subtext && <p className="mt-2 text-xs font-medium text-gray-500">{subtext}</p>}
  </button>
);
...
const Dashboard = () => {
  ...
  const { stats, statsStatus, statsError, items, status, summaryLoadingId, summaryError } =
    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          {/* <p className="mt-1 text-sm text-gray-500">
            Overview of your job applications, interview schedules, and prep readiness.
          </p> */}
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <SummaryCard
          ...
          onClick={() => navigate("/applications", { state: { status: "Applied" } })}
        />
        ...
        <SummaryCard
          ...
          onClick={() => navigate("/applications", { state: { status: "Offer Received" } })}
        />
        ...
        <SummaryCard
          ...
          onClick={() => navigate("/applications", { state: { status: "Rejected" } })}
        />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            {upcomingInterviews.length === 0 ? (
              <div className="py-8 text-center">
                <p className="text-sm font-semibold text-gray-700">No interviews scheduled yet</p>
                <p className="mt-1 text-xs text-gray-400">
                  Scheduled interviews will appear here automatically when updated.
                </p>
              </div>
            ) : (
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            <h2 className="text-base font-bold text-gray-900">Applications Status Breakdown</h2>
                  ...
                  {STATUS_GROUPS.map((group) => {
                    ...
                    return (
                      <div key={group.label} className="flex items-center justify-between text-sm">
                        ...
                        <div className="flex items-center gap-3">
                          <span className="text-gray-500 font-medium">{cnt} jobs</span>
                          <span className="w-12 text-right font-bold text-gray-900">{pct}%</span>
                        </div>
                      </div>
                    );
                  })}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-purple-700">
                  {aiSummariesCount} of {total} applications have AI Summaries ready.
                </p>
              </div>
            </div>
            <p className="mt-3 text-xs text-purple-800 leading-relaxed">
              Generate AI Summaries to get structured interview questions, key topics, and revision checklists tailored to each job!
            </p>
          </div>
              ...
              <div>
                <div className="mb-2 flex items-center justify-between gap-3">
                  ...
                  {!selectedApplication.aiSummary && (
                    <button
                      onClick={(e) => handleAiSummary(selectedApplication._id, e)}
                ...
                {selectedApplication.aiSummary ? (
                  ...
                  <>
                    ...
                    <p className="text-xs italic text-gray-400">
                      No AI summary generated yet. Click "Generate AI Summary" to create one using Gemini.
                    </p>
                  </>
                )}
              </div>
